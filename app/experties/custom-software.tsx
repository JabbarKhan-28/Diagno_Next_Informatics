                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={styles.contentContainer}>
                        ...
                        <Text style={[styles.description, isMobile && styles.descriptionMobile]}>
                            Tailored applications for laboratory management and clinical research focus on developing
                            customized software solutions that address the unique needs of laboratories and research
                            teams. These applications streamline sample tracking, workflow automation, data
                            management, and compliance monitoring, while also supporting advanced analytics for clinical
                            studies. By aligning with specific operational and research requirements, such solutions
