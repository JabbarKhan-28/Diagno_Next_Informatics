...
const IntegrationServiceScreen = () => {
                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={[styles.mainCard, isMobile && styles.mainCardMobile]}>
                        <Text style={[styles.title, isMobile && styles.titleMobile]}>
                            Integration of Diagnostic Devices & Middleware Systems
                        </Text>

                        <Text style={[styles.description, isMobile && styles.descriptionMobile]}>
                            Integration of Diagnostic Devices & Middleware Systems connects laboratory instruments and
                            middleware platforms with information systems to enable seamless data exchange, automation,
                            and real-time result reporting. This integration improves workflow efficiency, reduces manual
...
export default IntegrationServiceScreen;
