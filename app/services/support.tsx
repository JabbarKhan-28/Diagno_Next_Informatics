                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={[styles.mainCard, isMobile && styles.mainCardMobile]}>
                        <Text style={[styles.title, isMobile && styles.titleMobile]}>
                            Remote Support, Troubleshooting & Maintenance
                        </Text>

                        <Text style={[styles.description, isMobile && styles.descriptionMobile]}>
                            Remote Support, Troubleshooting & Maintenance deliver prompt, secure, and efficient
                            technical assistance for laboratories and clinics without the need for on-site visits. This
                            service includes diagnosing and resolving system issues, performing preventive
                            maintenance, and ensuring minimal downtime to keep operations running smoothly and
                            efficiently.
                        </Text>
...
export default SupportServiceScreen;
