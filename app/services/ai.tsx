                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={[styles.mainCard, isMobile && styles.mainCardMobile]}>
                        <Text style={[styles.title, isMobile && styles.titleMobile]}>
                             AI-Powered Diagnostic Assistance & Decision Support Modules
                        </Text>

                        <Text style={[styles.description, isMobile && styles.descriptionMobile]}>
                            AI-Powered Diagnostic Assistance & Decision Support Modules leverage advanced artificial
                            intelligence algorithms to analyze laboratory and clinical data, offering real-time insights,
                            predictive analytics, and evidence-based recommendations. These tools assist healthcare
                            professionals in making faster, more accurate diagnoses and treatment decisions,
