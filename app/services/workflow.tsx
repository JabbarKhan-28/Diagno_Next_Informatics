                    ...
                    <View style={[styles.mainCard, isMobile && styles.mainCardMobile]}>
                        ...
                        <View style={[styles.imagesGrid, isMobile && styles.imagesGridMobile]}>
                            <View style={styles.imagePlaceholder}>
                               <Image 
                                    source={require('../../assets/images/services/Workflow (1).png')} 
                             ...
                             <View style={styles.imagePlaceholder}>
                                <Image 
                                     source={require('../../assets/images/services/Workflow (2).png')} 
                                     style={styles.gridImage} 
                                     contentFit="cover"
                                     transition={200}
                                />
                             ...
                             <View style={styles.imagePlaceholder}>
                                <Image 
                                     source={require('../../assets/images/services/Workflow (3).png')} 
                                    style={styles.gridImage} 
                                    contentFit="cover"
                                    transition={200}
                                />
